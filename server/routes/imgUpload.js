...
// Upload Image
router.post("/", authentication, authorization, uploaad.single("file"), async (req, res) => {
  try {
    const directoryPath = path.join(__dirname, "uploads");
    let filePath = "";
...
// Delete Image
router.delete("/e-commerce-photos/:id", authentication, authorization, async (req, res) => {
  try {
